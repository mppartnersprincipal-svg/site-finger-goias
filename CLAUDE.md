...
2. **Design System**: só as 5 cores (Flame `#C44E2A`, Floral `#FFFCF2`, Timberwolf `#CCC5B9`, Olive
   `#403D39`, Eerie `#252422`) e alphas delas; nunca preto puro. Raios 2/6/8 px, **sem pílulas/círculos**.
...
- `lucide-react` 1.x não tem ícones de marca (Instagram está em `ui/icons.tsx`).
